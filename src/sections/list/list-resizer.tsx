...
import { isFunction, isNumber, throttle } from 'lodash';
...
const ListFormResizer = (props: Record<string, any>) => {
    ...
    const onMouseDown = (e: any) => {
        ...
        {
            if (
                e.offsetX > 0 && e.offsetX < BORDER_SIZE && isNonEmptyString(e?.target?.className) && e.target.className.indexOf('list-form-body') < 0
            ) {
                _window.m_pos = e.x;

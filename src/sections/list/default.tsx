import {
    ...
    Splitter, ListTable, LIST_CSS, ListFormResizer, ListHeader, hasErrorType, getLocalStorage
} from '../../index';
...
const DefaultList = (props: Record<string, any>) => {
    ...
    const { height, entity, search, hideListCategoriesTags, selectionType,  width } = props;
    ...
    const queryId = props.queryId?props.queryId:(queries.length>0 && entity.queries[0].id);
